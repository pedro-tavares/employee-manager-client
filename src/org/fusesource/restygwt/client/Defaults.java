...
public class Defaults {
    ...
    // this is the setHeader("Access-Control-Allow-Headers", "content-type, x-http-method-override")
    private static boolean addXHttpMethodOverrideHeader = false; // default true, false needed for CORS
