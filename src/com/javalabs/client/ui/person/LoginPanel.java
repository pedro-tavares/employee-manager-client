...
import com.javalabs.client.ui.dialogs.CreateAccountDialog;
...
*/			
				...
				EmployeeManager.letsGo(emailField.getText());				
			}
		});
	...
	private void callLoginService() {
		...
		ServiceFactory.PERSON_SERVICE.login(user, new MethodCallback<String>() {
			...
			public void onSuccess(Method method, String response) {
				...
				EmployeeManager.letsGo(response);
			}
			...
			public void onFailure(Method method, Throwable exception) {
				...
				EmployeeManager.letsGo(method.getResponse().getText());
